export default function SobreMiSection() {
  return (
    <section id="sobre-mi" className="bg-sand py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-[0.8fr_1.2fr] gap-14 items-center">
          <div className="aspect-[3/4] bg-gradient-to-br from-sand to-plum" />
          <div>
            ...
            <div className="flex gap-3 flex-wrap mb-5">
              {['Empática', 'Estratégica', 'Comprometida'].map((b) => (
                <span
                  key={b}
                  className="font-display italic text-sm border border-terracotta rounded-full px-4 py-2"
                >
                  {b}
                </span>
              ))}
